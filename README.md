...
```javascript
import complex from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32@v0.4.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Complex64, base, conj, imag, parseComplex64, real, reim, reviveComplex64 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32@v0.4.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32@v0.4.0-deno/mod.js';
